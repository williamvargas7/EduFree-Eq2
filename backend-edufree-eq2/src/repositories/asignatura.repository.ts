...
import {Asignatura, AsignaturaRelations, ProgramaAcademico, Grupos} from '../models';
...
> {
  ...
  public readonly grupos: HasManyRepositoryFactory<Grupos, typeof Asignatura.prototype.id>;

  constructor(
    @inject('datasources.MongoDB') dataSource: MongoDbDataSource, @repository.getter('ProgramaAcademicoRepository') protected programaAcademicoRepositoryGetter: Getter<ProgramaAcademicoRepository>, @repository.getter('GruposRepository') protected gruposRepositoryGetter: Getter<GruposRepository>,
  ) {
